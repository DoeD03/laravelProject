...
<head>
    ...
    <title>New Entry — The Daybook</title>
...
<div class="page">
    ...
    <form method="POST" action="{{ route('tasks.store') }}">
        ...
        <div class="field">
            ...
            <textarea id="description" name="description" placeholder="Any details worth noting"
                      class="@error('description') invalid @enderror">{{ old('description') }}</textarea>
            @error('description')
                <div class="error-text">{{ $message }}</div>
            @enderror
        </div>
